cdef extern from "../unuran/include/unuran.h":
    ...
    UNUR_URNG* unur_urng_builtin()

    UNUR_URNG* unur_urng_builtin_aux()

    ctypedef double (*_unur_urng_fvoid_new_urand_ft)(void* state)

    ctypedef void (*_unur_urng_fvoid_new_reset_ft)(void* state)

    UNUR_URNG* unur_urng_fvoid_new(_unur_urng_fvoid_new_urand_ft urand, _unur_urng_fvoid_new_reset_ft reset)
    ...
    UNUR_DISTR* unur_distr_cvec_get_stdmarginal(UNUR_DISTR* distribution, int n)
